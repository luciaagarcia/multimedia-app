...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onClickRemove = function (cue) {
        this.track.removeCue(cue);
    };
    AppComponent.prototype.onEnterCuePoint = function ($event) {
        this.activeCuePoints.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: $event.id }, JSON.parse($event.text)));
    };
    AppComponent.prototype.onExitCuePoint = function ($event) {
        this.activeCuePoints = this.activeCuePoints.filter(function (c) { return c.id !== $event.id; });
    };
    ...
    AppComponent.prototype.reanudarVideo = function () {
        this.api.currentTime = this.api.currentTime + 5;
        this.api.play();
    };
    AppComponent.prototype.ComprobarAcierto = function (cuePoint, boton) {
